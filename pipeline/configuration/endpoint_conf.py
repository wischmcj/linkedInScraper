...
mappings = {
    ...
    "jobs_by_company": [
        ...
        ("job_id", get_replace_func("entity_urn", [("urn:li:fsd_jobPosting:", "")])),
        (
            "company_id",
        ...
        ("is_remote", lambda resp: "remote" in resp["secondary_description"].lower()),
        ("is_hybrid", lambda resp: "hybrid" in resp["secondary_description"].lower()),
